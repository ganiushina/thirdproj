...
public class UserBonus {
    ...
    static {
        ...
        COLUMN_MAPPINGS.put("money_itog", "moneyAll");
        COLUMN_MAPPINGS.put("money_by_candidate", "moneyByCandidate");
        COLUMN_MAPPINGS.put("persent", "percent");
        COLUMN_MAPPINGS.put("summ_total", "sumTotal");
        COLUMN_MAPPINGS.put("summ_user", "sumUser");
