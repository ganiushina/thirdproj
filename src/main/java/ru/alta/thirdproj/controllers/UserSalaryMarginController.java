...
//@Controller
//@CrossOrigin("*")
////@RequestMapping("/margin") //http://localhost:8181/userbonus/api/v1/userbonus/all?date1=2021-12-01&date2=2021-12-31&userId=-1&departmentId=-1
//@Api("Set of endpoints for CRUD operations for User")
//public class UserSalaryMarginController {
...
//        return "tabs_margin"; // Renders the main tabs.html template
//    }
//
//    @GetMapping("/margin/getMarginMonth") // http://192.168.0.240:8181/userbonus/salary/getSalaryAll?date1=2024-06-01&date2=2024-06-30
...
//     //   return "margin";
//  //      return "fragments/month :: monthTable"; // Return only the homeTable fragment
//      return "fragments/home :: homeTable"; // Return only the homeTable fragment
//
//    }
//
//    @GetMapping("/margin/getMarginQuarter") // http://localhost:8189/userbonus/actPut/allact?date1=2022-06-01&date2=2022-06-27
//    //    @ApiOperation("Returns list of all products data transfer objects")
//
...
//        model.addAttribute("date2", date2);
//     //   return "margin";
//     //   return "fragments/quarter :: quarterTable"; // Return only the homeTable fragment
