...
@Component
public class UserLoginRepositorySlqO2 {
    ...
    public UserLoginRepositorySlqO2(@Autowired Sql2o sql2o) {
        this.sql2o = sql2o;
    }
    ...
    public UserLogin getUser(String userName) {
        try (Connection connection = sql2o.open()) {
            return connection.createQuery(SELECT_USER_QUERY)
                    ...
                    .setColumnMappings(UserLogin.COLUMN_MAPPINGS)
                    .executeAndFetchFirst(UserLogin.class);
        }
    }
    ...
    public List<UserLogin> getUsers() {
        try (Connection connection = sql2o.open()) {
            return connection.createQuery(SELECT_USER_QUERY, false)
                    .setColumnMappings(UserLogin.COLUMN_MAPPINGS)
                    .executeAndFetch(UserLogin.class);
        }
    }
